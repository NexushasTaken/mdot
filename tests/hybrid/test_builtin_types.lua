...
function testBuiltinTypesOptional()
   ...
   lu.assertEquals(err, "expected type optional string, got number: 1")
   ...
   lu.assertEquals(err, "expected type optional number, got string: \"\"")
   ...
   lu.assertEquals(err, "expected type optional function, got number: 1")
   ...
   lu.assertEquals(err, "expected type optional boolean, got number: 1")
   ...
   lu.assertEquals(err, "expected type optional table, got number: 1")

   _, err = t.null:optional()(nil)
   lu.assertEquals(err, "")
   _, err = t.null:optional()(1)
   lu.assertEquals(err, "expected type optional nil, got number: 1")
